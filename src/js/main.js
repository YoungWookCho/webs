            ...
            $.ajax({
                ...
                success: function (items) {
                    for (var i=0;i<items.length;i++) {
                        ...
                        $(".section-contents.section01>ul").append(sectionHTML);
                    }
            ...
            $.ajax({
                ...
                success: function (items) {
                    for (var i=0;i<items.length;i++) {
                        ...
                        var sectionHTML = "<li>";
                        sectionHTML += "<div class=\"section-img-box\" style=\"background-image: url('"+item.img+"')\">";
                        sectionHTML +=   "<div class=\"layer-darker\">";
                        sectionHTML +=   "<div class=\"img-box-text\">";
                        sectionHTML +=    "<div class=\"img-box-title\">"+item.title+" </div>";
                        sectionHTML += "<div class=\"img-box-divider\"></div>";
                        sectionHTML +=    "<div class=\"img-box-\">\""+item.desc+"\"</div>";
                        sectionHTML +=   "</div>";
                        sectionHTML +=   "<div class=\"editor-box\">";
                        sectionHTML +=    "<div class=\"editor-pic\" style=\"background-image: url('"+item.editorPic+"')\">";
                        sectionHTML +=   "</div >";
                        ...
                        $(".section-contents.section02>ul").append(sectionHTML);
                    }
